              ...
              'application/json': {
                schema: {
                  ...
                  properties: {
                    ...
                    regions_url: { type: 'string', description: 'URL of the structured region registry.' },
                    ...
                    agent_toc: {
                      ...
                      properties: {
                        ...
                        why_costs_exist: {
                          type: 'object',
                          properties: {
                            search_credits: { type: 'string' },
                            pagination_escalation: { type: 'string' },
                            contact_info_ban: { type: 'string' },
                            rate_limits: { type: 'string' },
                            pre_purchase_limits: { type: 'string' },
                          },
                          required: ['search_credits', 'pagination_escalation', 'contact_info_ban', 'rate_limits', 'pre_purchase_limits'],
                        },
                      },
                      required: ['welcome', 'deal_structures', 'start_here', 'happy_path', 'capabilities', 'invariants', 'trust_safety_rules', 'why_costs_exist'],
                    },
                  },
                  required: ['api_version', 'required_legal_version', 'openapi_url', 'categories_url', 'categories_version', 'regions_url', 'mcp_url', 'legal_urls', 'support_url', 'docs_urls', 'agent_toc'],
                },
              },
            },
          },
