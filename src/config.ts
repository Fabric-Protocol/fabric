...
export const config = {
  ...
  signupGrantCredits: Number(process.env.SIGNUP_GRANT_CREDITS ?? 500),
  creditRedeemEnabled: parseBoolean(process.env.CREDIT_REDEEM_ENABLED, Boolean((process.env.CREDIT_REDEEM_CODE ?? '').trim())),
  creditRedeemCode: process.env.CREDIT_REDEEM_CODE ?? '',
  creditRedeemGrantCredits: Number(process.env.CREDIT_REDEEM_GRANT_CREDITS ?? 0),
  ...
  bootstrapIdentityReuseGuardEnabled: parseBoolean(process.env.BOOTSTRAP_IDENTITY_REUSE_GUARD_ENABLED, true),
  bootstrapIdentityReuseGuardLookbackHours: Number(process.env.BOOTSTRAP_IDENTITY_REUSE_GUARD_LOOKBACK_HOURS ?? 24),
  bootstrapIdentityReuseGuardSubnetPrefixV4: Number(process.env.BOOTSTRAP_IDENTITY_REUSE_GUARD_SUBNET_PREFIX_V4 ?? 22),
  bootstrapIdentityReuseGuardNodeThreshold: Number(process.env.BOOTSTRAP_IDENTITY_REUSE_GUARD_NODE_THRESHOLD ?? 6),
  bootstrapIdentityReuseGuardPublishedProjectionThreshold: Number(process.env.BOOTSTRAP_IDENTITY_REUSE_GUARD_PUBLISHED_PROJECTION_THRESHOLD ?? 1),
  ...
  rateLimitCreditRedeemPerHour: Number(process.env.RATE_LIMIT_CREDIT_REDEEM_PER_HOUR ?? 10),
