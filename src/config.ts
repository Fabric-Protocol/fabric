...
export const config = {
  ...
  bconApiBase: process.env.BCON_API_BASE ?? 'https://external-api.bcon.global',
  bconStoreApiKey: process.env.BCON_STORE_API_KEY ?? '',
  bconCallbackSecret: process.env.BCON_CALLBACK_SECRET ?? '',
