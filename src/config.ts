...
export const config = {
  ...
  topupPack100PriceCents: Number(process.env.TOPUP_PACK_100_PRICE_CENTS ?? 400),
  topupPack300PriceCents: Number(process.env.TOPUP_PACK_300_PRICE_CENTS ?? 1200),
  topupPack1000PriceCents: Number(process.env.TOPUP_PACK_1000_PRICE_CENTS ?? 3800),
